...
export default function NuevoServicioPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMsg(data.msg || 'Error al crear servicio');
      }
    } catch (error) {
  ...
  // Botón rápido "+" para crear categoría por prompt (sigue existiendo)
  const handleNuevaCategoria = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Seleccionamos automáticamente la recién creada (por nombre)
  ...
  const saveEdit = async () => {
    ...
    try {
      ...
      await loadCategorias();
      // Si el servicio tenía seleccionada esta categoría por nombre, y cambió, actualizamos la selección
      if (formData.categoria && data.categoria?.nombre && categorias.find(c => c.id === editingId)?.nombre === formData.categoria) {
  ...
  const deleteCategory = async (cat: Category) => {
    ...
    try {
      ...
      await loadCategorias();
      // Si la categoría eliminada estaba seleccionada en el form, la deseleccionamos
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Crea un nuevo servicio o concepto de cobro
            </p>
          </div>
        </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        tipo: e.target.value as TipoServicio,
                      }))
                    }
                  >
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          categoria: e.target.value, // aquí guardamos el NOMBRE
                        }))
                      }
                    >
                    ...
                    {/* Botón rápido para crear por prompt */}
                    <button
                      type="button"
                    ...
                    {/* Botón Administrar Categorías (abre modal) */}
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        comisionCobrador: e.target.value,
                      }))
                    }
                    placeholder="12.5"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Porcentaje de comisión para cobradores externos
                  </p>
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-3">
                    Aplica a Subcategorías
                  </label>
                    ...
                    {subcategorias.map((subcategoria) => (
                      <label key={subcategoria} className="flex items-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleAplicaAChange(subcategoria, e.target.checked)
                          }
                        />
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Si no seleccionas ninguna, aplicará a todas
                  </p>
                </div>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-4 sm:p-6 border-b">
              <h3 id="admin-cat-title" className="text-lg font-semibold">
                      ...
                      {editingId === cat.id ? (
                        ...
                        <>
                          <div className="flex-1">
                            ...
                            {/* Atajo: seleccionar esta categoría para el formulario */}
                            <button
                              onClick={() => {
